...
export default function Home() {
  ...
  if(!showSignIn) return <main className="landing-shell"><div className="landing-glow"/><section className="landing-content"><img className="landing-logo" src="/logo.svg" alt="University OS"/><p className="eyebrow">UNIVERSITY OS</p><h1 className="landing-title"><span key={phraseIndex} className="landing-reveal"><span className="landing-static">{phrases[phraseIndex]}</span><span className="landing-reveal-dot" aria-hidden="true"/></span></h1><p className="landing-subtitle">Your academic workspace for courses, documents, deadlines and focused study.</p><button className="primary landing-signin" onClick={()=>setShowSignIn(true)}>Sign in</button></section></main>;
